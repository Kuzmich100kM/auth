...
module.exports.generateTokens = payload => {
	...
	const refreshToken = jwt.sign(payload, process.env.JWT_REFRESH_SECRET, { expiresIn: "3600s" })
...
module.exports.validateAccessToken = token => jwt.verify(token, process.env.JWT_ACCESS_SECRET)
